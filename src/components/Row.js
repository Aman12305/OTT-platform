    ...
    return(
        <div className="row">
            <h2>{title}</h2>
                ...
                {trailerUrl && <iframe title = {title}frameBorder="0" allow = "accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" height="390" width="70%" src={`${youtube_url}${trailerUrl}`} allowFullScreen ></iframe>}
